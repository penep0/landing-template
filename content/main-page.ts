...
export const mainPageContent: MainPageContent = {
  ...
  hero: {
    ...
    form: {
      ...
      feedbackSubmitLabel: "의견 보내기",
      feedbackSubmittingLabel: "의견 전송 중...",
      feedbackRequiredError: "의견을 입력한 뒤 보내주세요.",
      feedbackSuccessMessage: "의견이 전송되었습니다.",
